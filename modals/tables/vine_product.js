...
module.exports = function (sequelize, DataTypes) {
  ...
  vine_product.associate = (models) => {
    vine_product.belongsTo(models.vine_product_meta, { as: 'product_meta', foreignKey: 'product_id' });
    vine_product.belongsToMany(models.vine_category, { through: models.vine_product_category, as: 'product_category', foreignKey: 'product_id' });
